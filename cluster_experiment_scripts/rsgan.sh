...
python gan_loss_iter.py --image_size 128 --n_iter 51000 --input_folder /disk/scratch/s1832582 --output_folder ~/paintings_rsgan --n_gpu 4 --loss_D 5 --gen_every 50000 --extra_folder ~/paintings_rsgan/extraRS
